    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 xl:px-12">
        ...
        <div className="mt-16 pt-8 border-t border-black/[0.05] text-center">
          ...
          <a href="#contact" className="inline-flex items-center gap-1.5 text-[0.88rem] font-bold text-[#f97316] hover:gap-3 transition-all duration-300">
            Nous contacter directement <span aria-hidden="true">↓</span>
          </a>
        </div>
