    ...
    <>
      ...
      <section className="relative min-h-[100dvh] overflow-hidden flex flex-col">
        ...
        <motion.div
          ...
          transition={{ duration: 0.85, ease: SPRING, delay: 1.3 }}
        ...
        <div className="relative z-10 mt-auto w-full">
          <div className="max-w-7xl mx-auto px-5 sm:px-8 xl:px-16 pb-14 md:pb-20">
              ...
              <motion.div variants={fadeUp}>
                <span className="inline-flex items-center gap-2.5 rounded-full px-4 py-1.5 bg-white/[0.1] backdrop-blur-md ring-1 ring-white/[0.15] text-[11px] uppercase tracking-[0.2em] font-semibold text-white/90">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#f97316] opacity-70" />
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, ease: SPRING, delay: 1.5 }}
              className="hidden md:flex items-center gap-1.5 absolute bottom-14 md:bottom-20 right-5 md:right-10 text-white/40 text-[12px] font-medium"
            >
