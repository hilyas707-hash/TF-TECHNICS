  ...
  return (
    <section id="services" className="relative bg-white py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 xl:px-12">
        ...
        <div className="mt-20 pt-8 border-t border-black/[0.05] text-center">
          <p className="text-[0.88rem] text-[#6b6b6b] mb-2.5">
            Des centaines de clients à Bruxelles et en Brabant nous font déjà confiance.
          </p>
          <a href="#confiance" className="inline-flex items-center gap-1.5 text-[0.88rem] font-bold text-[#f97316] hover:gap-3 transition-all duration-300">
            Découvrez leurs témoignages <span aria-hidden="true">↓</span>
          </a>
        </div>
